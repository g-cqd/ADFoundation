...
public enum UnicodeSets {
    ...
    public static func isCleanTextRemoved(_ v: UInt32) -> Bool { contains(UnicodeTables.cleanTextRemoval, v) }
    public static func isJsWhitespace(_ v: UInt32) -> Bool { contains(UnicodeTables.jsWhitespace, v) }
    public static func isNonspacingMark(_ v: UInt32) -> Bool { contains(UnicodeTables.nonspacingMark, v) }
    public static func isBertPunctuation(_ v: UInt32) -> Bool { contains(UnicodeTables.bertPunctuation, v) }
    public static func isChinese(_ v: UInt32) -> Bool { contains(UnicodeTables.chineseChar, v) }
